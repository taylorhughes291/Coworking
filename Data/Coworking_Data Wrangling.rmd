...
MarketCensus <- subset(MarketCensus, select = -c(Location, Tract, DriveTime, BikeTime, TransitTime, WalkTime, ArrivalTime, Age, Occupation, TotalIncome, IncomeAdjuster, PUMA))
```
...
Census <- subset(Census, select = -c(ArrivalTime, Age, Occupation, IncomeAdjuster, PUMA))
```
