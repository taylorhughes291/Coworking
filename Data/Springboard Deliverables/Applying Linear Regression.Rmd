...
```{r}
CoworkScores <- ggplot(data = MarketCensus, mapping = aes(x = factor(0), y = CoworkMember)) + geom_point(position = "jitter")
CoworkScores
```
...
CoworkCompare <- ggplot(data = MarketCensusPlot, mapping = aes(x = Set, y = CoworkMember)) + geom_point(position = "jitter")
CoworkCompare
```
