...
model2 <- lm(CoworkMember ~ TransportationMode + AgeBracket + ClassOfWorker + OccupationType + Sex + MaritalStatus + HealthInsurance + HomeOffice + EducationLevel + RelativeIncome, data = TrainCensus)
```